    ...
    supabase.from("lesson_reports").upsert(
      [
        ...
        },
        {
          ...
          student_id: "22222222-2222-2222-2222-222222222223",
          lesson_memo:
            "오늘 현재완료와 과거시제 비교 수업. 개념은 이해했지만 문장 전환에서 시제 실수가 있었음. 숙제 20문제 중 16문제 완료.",
          progress: "현재완료와 과거시제 비교",
          weakness: "시제 구분, 문장 전환",
          homework_status: "20문제 중 16문제 완료",
          next_plan: "현재완료 표현 복습 후 독해 지문 적용 연습",
          parent_report:
            "안녕하세요. 오늘 박민준 학생은 현재완료와 과거시제의 차이를 중심으로 학습했습니다. 기본 개념은 잘 따라왔지만 문장을 바꿔 쓰는 과정에서 시제 선택 실수가 일부 있었습니다. 숙제는 20문제 중 16문제를 완료했습니다. 다음 수업에서는 현재완료 표현을 다시 정리하고 독해 지문에 적용하는 연습을 진행하겠습니다.",
          created_at: "2026-05-16T18:40:00+09:00",
        },
        {
          ...
          student_id: "22222222-2222-2222-2222-222222222223",
          lesson_memo:
            "오늘 수동태 기본 문장 수업. 목적어를 주어로 바꾸는 흐름은 이해했지만 be동사 형태에서 실수가 있었음. 숙제 18문제 중 13문제 완료.",
          progress: "수동태 기본 문장",
          weakness: "be동사 형태, 목적어 전환",
          homework_status: "18문제 중 13문제 완료",
          next_plan: "현재완료 도입과 시제 비교",
          parent_report:
            "안녕하세요. 오늘 박민준 학생은 수동태 문장의 기본 구조를 학습했습니다. 목적어를 주어로 바꾸는 흐름은 이해했지만 be동사 형태를 고르는 과정에서 실수가 있었습니다. 숙제는 18문제 중 13문제를 완료했습니다. 다음 수업에서는 현재완료를 도입하고 기존 시제와 비교하며 정리하겠습니다.",
          created_at: "2026-05-09T18:40:00+09:00",
        },
        {
          ...
          student_id: "22222222-2222-2222-2222-222222222224",
          lesson_memo:
            "오늘 등차수열과 등비수열 비교 수업. 공차와 공비 구분은 가능하나 식 세우기에서 시간이 걸림. 숙제 14문제 중 10문제 완료.",
          progress: "등차수열과 등비수열",
          weakness: "공차·공비 구분, 식 세우기",
          homework_status: "14문제 중 10문제 완료",
          next_plan: "점화식 기본 유형 연결",
          parent_report:
            "안녕하세요. 오늘 이하린 학생은 등차수열과 등비수열의 차이를 중심으로 수업했습니다. 공차와 공비를 구분하는 것은 가능했지만 문제 조건을 식으로 세우는 과정에서 시간이 조금 걸렸습니다. 숙제는 14문제 중 10문제를 완료했습니다. 다음 수업에서는 이 내용을 점화식 기본 유형과 연결해 정리하겠습니다.",
          created_at: "2026-05-16T20:10:00+09:00",
        },
        {
          ...
          student_id: "22222222-2222-2222-2222-222222222224",
          lesson_memo:
            "오늘 수열의 기본 개념 수업. 일반항 찾기는 따라오지만 계산 정리 과정에서 실수가 있었음. 숙제 12문제 중 9문제 완료.",
          progress: "수열의 기본 개념",
          weakness: "일반항 찾기, 계산 정리",
          homework_status: "12문제 중 9문제 완료",
          next_plan: "등차수열과 등비수열 유형 연습",
          parent_report:
            "안녕하세요. 오늘 이하린 학생은 수열의 기본 개념과 일반항을 찾는 방법을 학습했습니다. 풀이 방향은 잘 잡았지만 계산을 정리하는 과정에서 작은 실수가 있었습니다. 숙제는 12문제 중 9문제를 완료했습니다. 다음 수업에서는 등차수열과 등비수열 유형을 나누어 연습하겠습니다.",
          created_at: "2026-05-09T20:10:00+09:00",
        },
      ],
      { onConflict: "id" },
    ),
    ...
    supabase.from("message_queue").upsert(
      [
        ...
        },
        {
          ...
          message_status: "pending",
          message_body:
            "안녕하세요, 박민준 학부모님. 박민준 학생의 다음 수업이 2026-05-25 18:00에 예정되어 있어 수업 준비 차 안내드립니다. 이번 4회차 수업료는 280,000원이며, 결제 예정일은 2026-05-25입니다. 확인 가능하실 때 편하게 처리 부탁드립니다.",
          created_at: "2026-05-23T01:10:00+09:00",
        },
      ],
      { onConflict: "id" },
